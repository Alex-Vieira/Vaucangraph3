 ...
 */
public class vEdge extends vGraphCell implements Edge {

    /** Portas de origem e destino da aresta */
     ...
     */
    public vEdge(Object userObject) {
     ...
     * reference to the user object
     */
    public vEdge(Object userObject, AttributeMap storageMap) {
    ...
    /**
     * Sets the source of the edge.
     * @param port the target port to set
     */
